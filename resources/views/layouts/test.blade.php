    ...
    <nav>
      ...
      @else
        ...
        <ul class="clearfix icon">
          <li>
            <a class="container" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="fas fa-sign-out-alt"></i><span>ログアウト</span></a>
