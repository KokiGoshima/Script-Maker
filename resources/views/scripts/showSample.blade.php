  ...
  <carousel-3d :perspective="0" :space="200" :display="5" :controls-visible="true" :controls-prev-html="'❬'" :controls-next-html="'❭'" :controls-width="30" :controls-height="60" :clickable="true">
    ...
    <slide :index="0">
      <div class="example">
        ...
        <span id="english-script1">Good afternoon ladies and gentlemen. Welcome to company  information session. On behalf of XXX, I would like to welcome you here today.  My talk will be in three parts.  First is company's outline. Second is corporate philosophy. Third is Recruitment information. Now let's begin.
